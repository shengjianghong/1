...
def userpage(username):
    ...
    if request.method == 'POST':  # when we submit a form
        ...
        #### add quiz stuff here ####
        page += '<p><font color=red>Question</font></p>\n'
        page += '<div id="quiz"></div>\n'
        page += '<button id="submit">Check answer</button>\n'
        page += '<div id="results"></div>\n'
        page += '<script type="text/javascript" src="static/quiz.js"></script>\n'
        #############################
